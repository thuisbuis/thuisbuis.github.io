!((// in IIFE so nothing in the global scope, no export either
    ...
    customElements.define('roads-video', class extends HTMLElement {
        constructor() {
            super()
            ...
            var template = document.getElementById('roads-video-template1').content;
    ...
    customElements.define("roads-video-chapter", class extends HTMLElement {
        constructor() {
            super();
        }
        seen(state = false) {
